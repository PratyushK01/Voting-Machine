...
#define CANDIDATE1 "Archie's ice cream"
#define CANDIDATE2 "Arya the magician"
#define CANDIDATE3 "Topper Prats"
#define CANDIDATE4 "Pappu"

int votesCount1 = 0, votesCount2 = 0, votesCount3 = 0, votesCount4 =
  0 ,spoiledtvotes = 0;
...
castVote ()
{
  ...
  printf ("\n 5. %s", "None of these maha(purushes/mahila)");
  ...
  do
    {
      ...
      printf ("\n\n ###### Welcome to SRM Election/Voting 2022 ######");
	...
	default:
	  printf ("\n ##### Thanks for using our voting code #####");
